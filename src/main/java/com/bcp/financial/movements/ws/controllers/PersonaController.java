...
@RestController
@RequestMapping(Config.PERSONAS)
public class PersonaController {
    ...
    public ResponseEntity<Persona> getById(@PathVariable("id") long id) {
        Optional<Persona> _persona = service.findById(id);
        return _persona.map(entity -> new ResponseEntity<>(entity, HttpStatus.OK))
    ...
    public ResponseEntity<Persona> save(@RequestBody Persona persona) {
        try {
            Persona _persona = service.save(persona);
    ...
    public ResponseEntity<Persona> update(@RequestBody Persona persona, @PathVariable("id") Long id) {
        Optional<Persona> _persona = service.update(persona, id);
        return _persona.map(entity -> new ResponseEntity<>(entity, HttpStatus.OK))
                .orElse(new ResponseEntity<>(HttpStatus.NOT_FOUND));
    }
